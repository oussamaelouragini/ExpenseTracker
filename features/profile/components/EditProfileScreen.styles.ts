...
export const es = StyleSheet.create({
  ...
  securityRowBorder: { borderBottomWidth: 1, borderBottomColor: EC.border },
  securityIconWrapper: {
    width: 44,
    height: 44,
    borderRadius: 14,
  ...
  securityDesc: { fontSize: 12, color: EC.onVariant },

  // Check icon — blue circle
  checkCircle: {
    width: 28,
    height: 28,
    borderRadius: 14,
  ...
  aiCard: {
    marginHorizontal: 16,
    backgroundColor: EC.purpleLight,
    borderRadius: 20,
    padding: 18,
  },
  aiTopRow: {
